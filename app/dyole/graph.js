...
var Graph = (function () {
    ...
    Graph.prototype = {
        ...
        _attachEvents: function () {
            ...
            this.Event.subscribe('node:add', function (model, constraintsArg) {

                var constraints = _.extend(_self.constraints, constraintsArg);
        ...
        _initCanvasMove: function () {
            ...
            move = function onMove(x, y, dx, dy, event) {
                ...
                if (!canvasEmpty) {
                    ...
                    _self.Event.trigger('canvas:drag:move', {
                        x: (translation.x + x) / currentZoomLevel.x, y: (
                        translation.y + y) / currentZoomLevel.y
                    });
                }
        ...
        _drawScrollbars: function () {
            ...
            var canvas = this.getEl(),
                ...
                hBar, vBar, canvasTransform, surface, surfaceDimensions, surfaceWidth, surfaceHeight, hX, hY, hW, vX, vY, vH, ratioL, ratioR, ratioT, ratioB, canvasTranslation;
        ...
        addNode: function (nodeModel, coords, rawCoords, constraints, onCreate) {
            ...
            var x = ( clientX - canvas.left ) - this.pipelineWrap.getTranslation().x, y = ( clientY - canvas.top  ) - this.pipelineWrap.getTranslation().y;
        ...
        zoomIn: function () {
            ...
            if (zoomLevel.x < 1.2 && zoomLevel.y < 1.2) {
                ...
                canvas.scaleAtPoint(this.currentScale, {
